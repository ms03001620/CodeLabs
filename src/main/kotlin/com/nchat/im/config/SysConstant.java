...
public interface SysConstant {
    ...
    public static final float MIN_SOUND_RECORD_TIME = 1.5f;// 单位秒
    ...
    public static final String UPLOAD_IMAGE_INTENT_PARAMS = "com.nchat.im.upload.image.intent";
    public static final String UPLOAD_HEADER_IMAGE_INTENT_PARAMS = "com.nchat.im.upload.header_image.intent";
    public static final String UPLOAD_BACK_IMAGE_INTENT_PARAMS = "com.nchat.im.upload.back_image.intent";
    /**
     * event 优先级
     */
    ...
    public final static String INSTITUTION_AESKEY = "8CPYzXjY!";
